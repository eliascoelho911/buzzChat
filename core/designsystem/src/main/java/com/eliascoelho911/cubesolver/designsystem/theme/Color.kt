...
@Stable
class CubeSolverCustomColors

fun lightCubeSolverCustomColors() = CubeSolverCustomColors()

fun darkCubeSolverCustomColors() = CubeSolverCustomColors()

val LocalCubeSolverCustomColors = staticCompositionLocalOf {
    lightCubeSolverCustomColors()
}

@Composable
fun cubeSolverCustomColors(): CubeSolverCustomColors = LocalCubeSolverCustomColors.current